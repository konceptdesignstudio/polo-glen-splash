...
require_once CUR_FUNCTIONS.'common.php';
require_once CUR_FUNCTIONS.'theme.php';
...
//require_once CUR_FUNCTIONS.'taxonomy-meta.php';
...
require_once CUR_FUNCTIONS.'gallery.php';
require_once CUR_FUNCTIONS.'hooks.php';
